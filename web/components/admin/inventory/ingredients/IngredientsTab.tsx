...
import { Ingredient, useIngredientMutations, useIngredients } from "@/lib/hooks"
...
export function IngredientsTab() {
  ...
  const [ingredientCategoryFilter, setIngredientCategoryFilter] = useState("none")
  ...
  const { data: ingredients, isLoading, error, mutate: refetchIngredients } = useIngredients()
  
  // Ingredient mutations
  const { createIngredient, updateIngredient, deleteIngredient } = useIngredientMutations()
  ...
  const handleEditIngredient = async (id: string, ingredientData: {
    name: string
    description: string
    unit: string
    minQuantity: number
